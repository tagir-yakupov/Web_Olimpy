"""
Blueprint для панели администратора (добавление теории)
"""
...
def conf():
    """Страница добавления новой задачи в теорию по математике"""
    ...
    <div class="solution-toggle" onclick="toggleSolution('{num}')">
        ...
        # Поиск места для вставки (кнопка "Вернуться ко всем темам")
